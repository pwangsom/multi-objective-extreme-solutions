...
public class DaDagSolutionOutput {

	private FileOutputContext varFileContext;
	private FileOutputContext funFileContext;
	private String varFileName = "solution.out";
	private String funFileName = "objective.out";
	private String separator = ",";
	private List<? extends Solution<?>> solutionList;
	private List<Boolean> isObjectiveToBeMinimized;

	public DaDagSolutionOutput(List<? extends Solution<?>> solutionList) {
	    varFileContext = new DaDagFileOutputContext(varFileName);
	    funFileContext = new DaDagFileOutputContext(funFileName);
	...
	public DaDagSolutionOutput setVarFileOutputContext(FileOutputContext fileContext) {
		varFileContext = fileContext;

		return this;
	}

	public DaDagSolutionOutput setFunFileOutputContext(FileOutputContext fileContext) {
		funFileContext = fileContext;

		return this;
	}

	public DaDagSolutionOutput setObjectiveMinimizingObjectiveList(List<Boolean> isObjectiveToBeMinimized) {
		this.isObjectiveToBeMinimized = isObjectiveToBeMinimized;

		return this;
	}

	public DaDagSolutionOutput setSeparator(String separator) {
