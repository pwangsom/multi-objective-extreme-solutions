...
public class NsgaIIIContinueable<S extends Solution<?>> extends AbstractContinueableGeneticAlgorithm<S> {
	
	private Logger logger = Logger.getLogger(NsgaIIIContinueable.class);
	...
	public NsgaIIIContinueable(NsgaIIIContinueableBuilder<S> builder) {
		super(builder.getProblem(), builder.getInitialPopulation());
	    ...
	    logger.info("rpssize: " + referencePoints.size());
	}
	...
	public String getName() {
		return "NSGA-III Continuity";
	}

	@Override
	public String getDescription() {
		return "Nondominated Sorting Genetic Algorithm version III with Continuity";
	}
