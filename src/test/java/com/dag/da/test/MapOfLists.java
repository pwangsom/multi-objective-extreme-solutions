...
public class MapOfLists {
	...
	private static void implementOne() {
		//Using List
	...
	@SuppressWarnings("unchecked")
	private static void implementTwo() {
		//Using ArrayList
		
/*		// create two hash maps
		Map<Integer, ArrayList<String>> newmap1 = new TreeMap<Integer, ArrayList<String>>();
		Map<Integer, ArrayList<String>> newmap2 = new TreeMap<Integer, ArrayList<String>>();

		// populate 1st map
		newmap1.put(1, ["tutorials", "tu"]);
		newmap1.put(2, Arrays.asList("is", "the"));
		newmap1.put(3, Arrays.asList("best", "of best"));

		// clone 1st map
		newmap2 = (Map<Integer, ArrayList<String>>) ((TreeMap<Integer, ArrayList<String>>) newmap1).clone();
		...
		ArrayList<String> current = new ArrayArrayList<String>(); 
		current.addAll(newmap2.get(1));
		current.add("tong");
		newmap2.put(1, current);
